...
#r0 = requests.get("https://www.baidu.com/",stream=True)
...
#print(r0.encoding)           # 返回网页的编码: "utf-8"
#
...
#print(r0.raw)                # <requests.packages.urllib3.response.HTTPResponse object at 0x101194810>
#print(r0.raw.read(10))       # "\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\x03"
#
